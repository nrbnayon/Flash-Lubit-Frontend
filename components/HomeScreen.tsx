    ...
    <div className="flex flex-row justify-center w-full">
      <div className="w-full max-w-[1920px]">
        <div className="relative min-h-screen bg-[url(/background1.webp)] bg-cover bg-[50%_0%] px-4 md:px-6 lg:px-10">
          ...
          <div className="pt-10 pb-8 px-2 md:px-6 lg:px-12 max-w-full mx-auto custom-scrollbar">
            <div className="flex flex-col lg:flex-row justify-between gap-6 md:gap-8 lg:gap-12">
              <div className="flex flex-col md:flex-row lg:flex-row items-center md:items-start lg:items-start gap-4 md:gap-8 lg:gap-12 w-full lg:w-1/2">
                <div className="flex flex-col w-full md:w-[300px] lg:w-[401px] items-center gap-[15px]">
                  ...
                  <div className="flex w-full md:w-[280px] lg:w-[312px] items-center gap-3 md:gap-5 lg:gap-7">
                    ...
                    <Select>
                      <SelectTrigger className="utures h-10 md:h-12 flex-1 bg-[#ffffff4c] rounded-xl border border-solid border-[#7630b5] px-3 py-2 md:px-4 md:py-2.5">
                ...
                <div
                  ref={leftMessagesRef}
                  className="flex flex-col w-full md:w-[250px] lg:w-[299px] items-start gap-8 md:gap-12 lg:gap-20 px-0 py-4 md:py-6 lg:py-10 overflow-y-auto max-h-[482px] custom-scrollbar"
                >
              ...
              <div className="flex flex-col md:flex-row-reverse lg:flex-row-reverse items-center md:items-start lg:items-start gap-4 md:gap-8 lg:gap-12 w-full lg:w-1/2">
                ...
                <div
                  ...
                  className="flex flex-col w-full md:w-[250px] lg:w-[350px] items-end gap-8 md:gap-12 lg:gap-20 pt-4 md:pt-10 lg:pt-20 pb-0 px-0 overflow-y-auto max-h-[482px]"
                >
                  {chatMessages.map((msg, originalIndex) =>
                    msg.sender === "ai" ? (
                      <div
            ...
            >
              <DialogContent className="flex flex-col items-start gap-3 md:gap-5 p-4 md:p-6 bg-[#ffffff33] rounded-[20px] border border-[#7630b5] sm:max-w-[800px] max-h-[90vh] overflow-auto">
                ...
                <Button
                  ...
                  className="w-28 md:w-40 h-10 md:h-14 px-4 md:px-6 py-2 md:py-2 kış5 bg-[#7630b5] rounded-xl font-medium text-sm md:text-base"
                >
                  Analyze
                </Button>
              </DialogContent>
...
//   console.log("Get Left side::", leftAvatars);
//   console.log("Left side selected::", selectedLeftAvatar);

//   console.log("Get right side::", rightAvatars);
//   console.log("Right side selected::", selectedRightAvatar);
...
//       try {
//         const avatars = await getAvatarsApi();
//         // console.log("All avatar fetch::", avaters)
//         const userAvatars = avatars.filter((a) => a.side === "USER");
//         const aiAvatars = avatars.filter((a) => a.side === "AI");
//         setLeftAvatars(userAvatars);
//         setRightAvatars(aiAvatars);
